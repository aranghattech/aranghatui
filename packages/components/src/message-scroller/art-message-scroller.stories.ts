...
export const stories: ComponentStories = {
  ...
  frame: 'stack',
  examples: {
    basic: { title: 'Basic', render: () => `<art-message-scroller aria-label="Chat" ${box}>\n${thread(8)}\n</art-message-scroller>`, note: 'Give the scroller a height. It opens on the latest message; scroll up and the jump button appears; press it (or `scrollToEnd()`) to follow again.' },
