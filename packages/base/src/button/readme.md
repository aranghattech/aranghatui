...
| `hostAriaKeyshortcuts` | `aria-keyshortcuts` | The shortcut that activates the button (`Control+B`); announced with the focused native button.                                                                                                                                                                                                                        | `null \| string \| undefined`                                                 | `undefined` |
