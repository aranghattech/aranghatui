...
<p id="terms-3-help">You agree to our Terms of Service and Privacy Policy.</p>` },
  ...
  focusTarget: 'art-checkbox input',
  docs: {
    ...
    keyboard: [['Tab', 'Focus the checkbox'], ['Space', 'Toggle (native)']],
    roles: 'A native `<input type="checkbox">` — checked, indeterminate, required and disabled are platform semantics; the name comes from `aria-label` or `art-label` (resolved across the shadow boundary).',
