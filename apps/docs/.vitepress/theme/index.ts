...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      Promise.all([import('@aranghat/base'), import('@aranghat/components'), import('@aranghat/navigation'), import('@aranghat/modals'), import('@aranghat/widgets'), import('@aranghat/extended')]).then((tiers) => {
