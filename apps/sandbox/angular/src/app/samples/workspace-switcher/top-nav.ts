...
import { ArtMenuItem, ArtTopNav, ArtWorkspaceSwitcher, ArtWorkspaceSwitcherItem } from '@aranghat/navigation-angular';
import { ArtButton } from '@aranghat/base-angular';

@Component({
  selector: 'sample-workspace-switcher-top-nav',
  imports: [ArtButton, ArtMenuItem, ArtTopNav, ArtWorkspaceSwitcher, ArtWorkspaceSwitcherItem],
  template: `
    <art-top-nav>
...
export class WorkspaceSwitcherTopNavExample {}
