...
import { ArtMenuItem, ArtSidebar, ArtSidebarGroup, ArtSidebarInset, ArtSidebarMenu, ArtSidebarMenuButton, ArtSidebarMenuItem, ArtSidebarProvider, ArtWorkspaceSwitcher, ArtWorkspaceSwitcherItem } from '@aranghat/navigation-angular';
import { ArtSkeleton } from '@aranghat/base-angular';

@Component({
  selector: 'sample-workspace-switcher-sidebar',
  imports: [ArtMenuItem, ArtSidebar, ArtSidebarGroup, ArtSidebarInset, ArtSidebarMenu, ArtSidebarMenuButton, ArtSidebarMenuItem, ArtSidebarProvider, ArtSkeleton, ArtWorkspaceSwitcher, ArtWorkspaceSwitcherItem],
  template: `
...
export class WorkspaceSwitcherSidebarExample {}
