...
import { ArtMenuItem, ArtWorkspaceSwitcher, ArtWorkspaceSwitcherItem } from '@aranghat/navigation-angular';

@Component({
  selector: 'sample-workspace-switcher-compact',
  imports: [ArtMenuItem, ArtWorkspaceSwitcher, ArtWorkspaceSwitcherItem],
  template: `
...
export class WorkspaceSwitcherCompact {}
