...
import { ArtTreeItem, ArtTreeView } from '@aranghat/navigation-angular';

@Component({
  selector: 'sample-tree-view-icons',
  imports: [ArtTreeItem, ArtTreeView],
  template: `
