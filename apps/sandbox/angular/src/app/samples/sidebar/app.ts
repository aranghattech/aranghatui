...
import { ArtSidebar, ArtSidebarGroup, ArtSidebarInset, ArtSidebarMenu, ArtSidebarMenuButton, ArtSidebarMenuItem, ArtSidebarProvider, ArtSidebarTrigger, ArtTopNav } from '@aranghat/navigation-angular';
import { ArtButton, ArtSkeleton } from '@aranghat/base-angular';

@Component({
  selector: 'sample-sidebar-app',
  imports: [ArtButton, ArtSidebar, ArtSidebarGroup, ArtSidebarInset, ArtSidebarMenu, ArtSidebarMenuButton, ArtSidebarMenuItem, ArtSidebarProvider, ArtSidebarTrigger, ArtSkeleton, ArtTopNav],
  template: `
