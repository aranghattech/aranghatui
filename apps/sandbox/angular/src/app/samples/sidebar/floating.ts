...
import { ArtButton, ArtSeparator, ArtSkeleton } from '@aranghat/base-angular';

@Component({
  selector: 'sample-sidebar-floating',
  imports: [ArtBreadcrumb, ArtBreadcrumbItem, ArtButton, ArtSeparator, ArtSidebar, ArtSidebarGroup, ArtSidebarInset, ArtSidebarMenu, ArtSidebarMenuButton, ArtSidebarMenuItem, ArtSidebarProvider, ArtSidebarTrigger, ArtSkeleton],
  template: `
