...
import { ArtNavLink, ArtNavRail, ArtNavRailItem, ArtNavSection } from '@aranghat/extended-angular';
import { ArtAvatar } from '@aranghat/components-angular';

@Component({
  selector: 'sample-nav-rail-collapsed',
  imports: [ArtAvatar, ArtNavLink, ArtNavRail, ArtNavRailItem, ArtNavSection],
  template: `
