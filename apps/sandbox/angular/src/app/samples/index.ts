...
export const SAMPLES = [
  ...
  { id: 'mega-menu/basic', component: MegaMenuBasic },
  { id: 'mega-menu/columns', component: MegaMenuColumns },
  { id: 'mega-menu/max-columns', component: MegaMenuMaxColumns },
  { id: 'mega-menu/rows', component: MegaMenuRows },
  { id: 'mega-menu/max-rows', component: MegaMenuMaxRows },
  { id: 'mega-menu/full-width', component: MegaMenuFullWidth },
  { id: 'mega-menu/full-width-content', component: MegaMenuFullWidthContent },
  { id: 'mega-menu/per-item', component: MegaMenuPerItem },
  { id: 'mega-menu/aside-footer', component: MegaMenuAsideFooter },
  { id: 'mega-menu/active', component: MegaMenuActive },
  { id: 'mega-menu/icon-trigger', component: MegaMenuIconTrigger },
  { id: 'mega-menu/logo-trigger', component: MegaMenuLogoTrigger },
  { id: 'workspace-switcher/basic', component: WorkspaceSwitcherBasic },
  { id: 'workspace-switcher/compact', component: WorkspaceSwitcherCompact },
  { id: 'workspace-switcher/icon', component: WorkspaceSwitcherIcon },
  { id: 'workspace-switcher/top-nav', component: WorkspaceSwitcherTopNavExample },
  { id: 'workspace-switcher/sidebar', component: WorkspaceSwitcherSidebarExample },
  { id: 'workspace-switcher/collapsed', component: WorkspaceSwitcherCollapsed },
];
