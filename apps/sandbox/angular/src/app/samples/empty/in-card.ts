...
import { ArtButton, ArtCard, ArtEmpty, ArtIcon } from '@aranghat/base-angular';

@Component({
  selector: 'sample-empty-in-card',
  imports: [ArtButton, ArtCard, ArtEmpty, ArtIcon],
  template: `
    <art-card>
      <art-empty>
