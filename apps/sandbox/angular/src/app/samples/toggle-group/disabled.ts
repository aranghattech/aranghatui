...
import { ArtIcon, ArtToggle, ArtToggleGroup } from '@aranghat/base-angular';

@Component({
  selector: 'sample-toggle-group-disabled',
  imports: [ArtIcon, ArtToggle, ArtToggleGroup],
  template: `
...
export class ToggleGroupDisabled {}
