...
import { ArtNavigationMenu, ArtNavigationMenuItem, ArtNavigationMenuLink } from '@aranghat/navigation-angular';

@Component({
  selector: 'sample-navigation-menu-basic',
  imports: [ArtNavigationMenu, ArtNavigationMenuItem, ArtNavigationMenuLink],
  template: `
    <art-navigation-menu>
...
export class NavigationMenuBasic {}
