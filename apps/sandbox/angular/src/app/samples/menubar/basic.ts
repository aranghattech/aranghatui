...
import { ArtMenuItem, ArtMenuRadioGroup, ArtMenuSeparator, ArtMenuSub, ArtMenubar, ArtMenubarMenu } from '@aranghat/navigation-angular';

@Component({
  selector: 'sample-menubar-basic',
  imports: [ArtMenuItem, ArtMenuRadioGroup, ArtMenuSeparator, ArtMenuSub, ArtMenubar, ArtMenubarMenu],
  template: `
