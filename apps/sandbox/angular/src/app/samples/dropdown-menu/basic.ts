...
import { ArtDropdownMenu, ArtDropdownMenuGroup, ArtDropdownMenuItem, ArtDropdownMenuLabel, ArtDropdownMenuSeparator } from '@aranghat/navigation-angular';
import { ArtButton } from '@aranghat/base-angular';

@Component({
  selector: 'sample-dropdown-menu-basic',
  imports: [ArtButton, ArtDropdownMenu, ArtDropdownMenuGroup, ArtDropdownMenuItem, ArtDropdownMenuLabel, ArtDropdownMenuSeparator],
  template: `
    <art-dropdown-menu>
