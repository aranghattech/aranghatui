...
import { ArtNotificationCentre, ArtNotificationItem } from '@aranghat/widgets-angular';
import { ArtButton } from '@aranghat/base-angular';

@Component({
  selector: 'sample-notification-centre-unread',
  imports: [ArtButton, ArtNotificationCentre, ArtNotificationItem],
  template: `
...
export class NotificationCentreUnread {}
