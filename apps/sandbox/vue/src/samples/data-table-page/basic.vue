...
import { DataTablePage } from '@aranghat/widgets-vue';
import { Badge, Button, Checkbox, Table } from '@aranghat/base-vue';
</script>

<template>
  <DataTablePage filter-placeholder="Filter tasks…" total="100" page-count="10" page-size="10">
    ...
    <Table>
      <table>
        ...
        <tbody>
          ...
          <tr><td><Checkbox aria-label="Select row" /></td><td>TASK-7839</td><td><Badge variant="outline">Bug</Badge> We need to bypass the neural TCP card!</td><td>Todo</td><td>High</td></tr>
          ...
          <tr><td><Checkbox aria-label="Select row" /></td><td>TASK-8686</td><td><Badge variant="outline">Feature</Badge> I'll parse the wireless SSL protocol, that should driver the API panel!</td><td>Canceled</td><td>Medium</td></tr>
        </tbody>
      </table>
    </Table>
  </DataTablePage>
