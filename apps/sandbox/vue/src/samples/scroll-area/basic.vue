...
import { ScrollArea } from '@aranghat/components-vue';
import { Item } from '@aranghat/base-vue';
</script>

<template>
  <ScrollArea style="height: 18rem; width: 12rem; border: var(--art-border-width) solid var(--art-color-border-default); border-radius: var(--art-radius-md)">
    <Item size="sm">
