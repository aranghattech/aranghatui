...
import { NotificationCentre, NotificationItem } from '@aranghat/widgets-vue';
import { Button } from '@aranghat/base-vue';
</script>

<template>
  <NotificationCentre inline filter="unread">
    <NotificationItem value="n1" heading="Pedro mentioned you" description="in #design-system: “can you review the sidebar tokens?”" time="2m" unread href="#thread"><svg slot="media" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8"/></svg></NotificationItem>
    <NotificationItem value="n2" heading="Deploy finished" description="artui-docs v0.9.4 is live on production." time="1h" unread><svg slot="media" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/></svg></NotificationItem>
