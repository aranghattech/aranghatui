...
import { SettingsPage } from '@aranghat/widgets-vue';
import { Button, Field, Label, NativeSelect, Radio, RadioGroup } from '@aranghat/base-vue';
</script>

<template>
  <SettingsPage section-heading="Appearance" section-description="Customize the appearance of the app. Automatically switch between day and night themes.">
