...
import { OnboardingWizard, WizardStep } from '@aranghat/widgets-vue';
import { Field, Input, Label, NativeSelect } from '@aranghat/base-vue';
</script>

<template>
  <OnboardingWizard step="4" loading>
