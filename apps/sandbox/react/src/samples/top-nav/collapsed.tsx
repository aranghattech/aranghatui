import { TopNav } from '@aranghat/navigation-react';
import { Button } from '@aranghat/base-react';

export default function Collapsed() {
  return (
    <>
      <TopNav collapse="always" open>
        ...
        <a href="#">Products</a>
        <a href="#">Settings</a>
        <Button slot="end" variant="ghost" size="sm">Sign in</Button>
        <Button slot="end" size="sm">Get started</Button>
      </TopNav>
    </>
  );
}
